...
public class DetApprCutiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_det_appr_cuti);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            startActivity(new Intent(getApplicationContext(), ApprovalCutiMgrActivity.class));
                        } catch (JSONException e) {
                            e.printStackTrace();
