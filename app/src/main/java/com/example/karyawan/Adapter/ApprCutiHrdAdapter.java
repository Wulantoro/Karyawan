...
import com.example.karyawan.Activity.DetApprCutiHrdActivity;
...
public class ApprCutiHrdAdapter extends RecyclerView.Adapter<ApprCutiHrdAdapter.ViewHolder> {
    private List<Cuti> list;
    private Context context;

    public ApprCutiHrdAdapter(Context context) {
    ...
    @NonNull
    @Override
    public ApprCutiHrdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.list_cuti, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetApprCutiHrdActivity.class);
